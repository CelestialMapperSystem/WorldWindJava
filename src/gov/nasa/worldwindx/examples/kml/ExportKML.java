...
/**
 * Shows how to generate KML from WorldWind elements. This example creates
 * several objects, and writes their KML representation to stdout.
 *
 * @author pabercrombie
...
public class ExportKML
{
    ...
    protected static SurfaceEllipse makeSurfaceEllipse()
    {
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            OutputStream os = new FileOutputStream(Configuration.getUserHomeDirectory() + "/ExportKML1.kml");

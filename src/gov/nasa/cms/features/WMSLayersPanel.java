...
public class WMSLayersPanel extends JPanel
{
    ...
    public WMSLayersPanel(WorldWindow wwd, String server, Dimension size, CelestialMapper cms) throws URISyntaxException
    {
    ...
    protected class LayerInfoAction extends AbstractAction
    {
        ...
        public void actionPerformed(ActionEvent actionEvent)
        {
            ...
            // Tell the WorldWindow to update and refresh the LayerPanel
            wwd.redraw();

 ...
 */
public class CmsWmsLayersPanel extends JPanel
{
    protected static class LayerInfo
    {
        ...
        {
            return params.getStringValue(AVKey.LAYERS_CLASS_NAMES);
        }
    }
    ...
    public CmsWmsLayersPanel(WorldWindow wwd, String server, Dimension size) throws URISyntaxException
    {
    ...
    protected void load()
    {
        ...
        try
        {
            for (WMSLayerCapabilities lc : namedLayerCaps)
            {
                ...
                if (styles == null || styles.size() == 0)
                {
                    ...
                    CmsWmsLayersPanel.this.layerInfos.add(layerInfo);
                }
                else
                {
        ...
        EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                CmsWmsLayersPanel.this.removeAll();
    ...
    protected void makeLayerInfosPanel(Collection<LayerInfo> layerInfos)
    {
        ...
        {
            addLayerInfoPanel(layersPanel, CmsWmsLayersPanel.this.wwd, layerInfo);
        }
    ...
    protected void makeProgressPanel()
    {
        ...
        cancelButton.addActionListener(new AbstractAction()
        {
            public void actionPerformed(ActionEvent actionEvent)
            {
                ...
                Container c = CmsWmsLayersPanel.this.getParent();
                c.remove(CmsWmsLayersPanel.this);
            }
        });
